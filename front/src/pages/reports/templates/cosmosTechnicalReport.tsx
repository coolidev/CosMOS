...
export const report: Report = {
  name: `CART Technical Report`,
  description:
    'The CART Technical Report contains a general overview of all results of your analysis, including your network selection(s), mission parameters, coverage map, analytical charts, link budgets and performance results. ',
  fileType: 'DOCX',
  ...
  selected network. Table 1-2 shows the desired link parameters defined in CART
  ...
  describes the expected communications performance resulting from the CART simulation
  ...
  missions used to construct <span class=SpellE>CART's</span> database, Figures
