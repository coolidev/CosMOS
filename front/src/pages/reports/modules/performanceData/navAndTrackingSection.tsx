...
import { PLOT_LIST, NAVTRACKING_OPTIONS} from "src/utils/constants/reporting";
import { METRIC_LABELS } from 'src/utils/constants/analysis';

export function navAndTrackingSection(performance: PerformancePanel, showGraph: boolean): string {

    const values: { [key: string]: number } = {};
    
    let tableContents = '';
    Object.keys(values).forEach(attribute => {
        if(NAVTRACKING_OPTIONS.includes(attribute)){
            let rowTitle = '';
            let plot = '';
    ...
    return `
        ...
        style='font-size:14.0pt;color:white;mso-themecolor:background1'>Nav and Tracking</span></b><span
