...
//   };
  ...
  const AnalysisParametersSummary: FC<AnalysisParametersSummaryProps> = ({
    ...
    return (
        ...
        >
            <Accordion key={'analysisParameters'} className={classes.interiorBox} expanded={accordion[`analysisParameters`]}>
                <AccordionSummary id={`analysisParameters`} onClick={handleAccordion}>
